...
require (
	...
	golang.conradwood.net/apis/artefact v1.1.2084
	golang.conradwood.net/apis/auth v1.1.2084
	golang.conradwood.net/apis/common v1.1.2084
...
require (
	...
	golang.conradwood.net/apis/autodeployer v1.1.2084 // indirect
	golang.conradwood.net/apis/deploymonkey v1.1.2084 // indirect
	golang.conradwood.net/apis/echoservice v1.1.2073 // indirect
	golang.conradwood.net/apis/errorlogger v1.1.2073 // indirect
	golang.conradwood.net/apis/framework v1.1.2084 // indirect
	golang.conradwood.net/apis/goeasyops v1.1.2084 // indirect
	golang.conradwood.net/apis/registry v1.1.2084 // indirect
	golang.conradwood.net/apis/rpcinterceptor v1.1.2084 // indirect
